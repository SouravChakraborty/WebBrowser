...
// The Most Awesome Browser Ever!!!.
public class WebBrowser2 extends JFrame implements HyperlinkListener {
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;

	// Buttons for iterating through the page list.
	...
	public WebBrowser2() {
		// Title
		super("Most Awesome Browser Ever");
